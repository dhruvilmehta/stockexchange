...
const debounce = (func: Function, wait: number) => {
  ...
  return (...args: any[]) => {
    ...
    timeout = setTimeout(() => {
    //   console.log('Function invoked with args:', args);
      func(...args);
    }, wait);
  };
};

const debouncedGetTicker = debounce(
  (
    market: string,
    setTicker: React.Dispatch<React.SetStateAction<TickerType | null>>,
  ) => {
...
export const MarketBar = ({
  ...
  useEffect(() => {
    ...
    // }
    debouncedGetTicker(market, setTicker);
  }, [market, price]);
